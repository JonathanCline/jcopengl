#if !JCLIB_OPENGL_CUSTOM_LOADER_V
	#ifndef JCLIB_OPENGL_GLSYM_H
		#define JCLIB_OPENGL_GLSYM_H
		#include <glad/glad.h>
	#endif
#elif !defined(JCLIB_OPENGL_GLSYM_H)
#define JCLIB_OPENGL_GLSYM_H

// Detect opengl loader collision
#ifdef __gl_h_
	#error "OpenGL header already included, remove this include, jcopengl already provides it"
#endif
#define __gl_h_

// If we are on windows, grab apientry to avoid including windows.h
#if defined(_WIN32) && !defined(APIENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__)
	#define APIENTRY __stdcall
#endif

// Define rest of apientry related names
#ifndef APIENTRY
	#define APIENTRY
#endif
#ifndef APIENTRYP
...
#include <jclib/gl/KHR/khrplatform.h>
